...
import 'package:khrolovich_playground_app/screens/in_apps/weather_app/services/connection-check.dart';
import 'package:khrolovich_playground_app/screens/in_apps/weather_app/widgets/cities-list-model.dart';

class WeatherAppMyHomePage extends StatefulWidget {
  WeatherAppMyHomePage({Key key, this.title}) : super(key: key);
  final String title;

  @override
  _WeatherAppMyHomePageState createState() => _WeatherAppMyHomePageState();
}

class _WeatherAppMyHomePageState extends State<WeatherAppMyHomePage> {
  @override
  void initState() {
    super.initState();
